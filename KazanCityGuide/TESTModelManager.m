...
+ (Route *)getRoute {
    ...
    point.route = route;
    RouteQuizz *quizz = [[RouteQuizz alloc] init];
    quizz.routePoint = point;
    quizz.text = @"Попробуйте определить какое из этих зданий историческое";
    quizz.correctIndex = 3;
    quizz.imageSet = @[[UIImage imageNamed:@"img1"],
